...
namespace BankTest
{
    ...
    public class BankAccountTest
    {
        ...
        {
            BankAccount_Accessor target = new BankAccount_Accessor("Mr. Bryan Walton", 11.99);
        ...
        [DeploymentItem("BankTest\\data.xls"), DataSource("MyExcelDataSource"), TestMethod()]
        public void ExcelDataLoadTest()
        {
            Assert.AreEqual(testContextInstance.DataRow["Val1"], testContextInstance.DataRow["Val2"]);
        }
    }
}
